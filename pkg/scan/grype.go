...
type Options struct {
	...
	// DisableManifestCache controls whether the scanner will cache Manifests generated from
	// APKs. If true, the scanner will not cache Manifests or use existing cached Manifests.
...
var DefaultGrypeDBDir = path.Join(xdg.CacheHome, "trace", "grype", "db")
...
func NewScanner(opts Options) (*Scanner, error) {
	...
	return &Scanner{
		...
		disableSBOMCache:     opts.DisableManifestCache,
	}, nil
}
